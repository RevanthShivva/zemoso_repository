function showTable(var1){
    const s = document.getElementById("summary-" + var1);
    s.style.display="block";
}

function closeTable(var1){
    const s = document.getElementById("summary-" + var1);
    s.style.display="none";
}

const searchFun = ()=>{
    let var1 = document.getElementById('serach').value.toUpperCase();
    for(var i =0;i<3;i++){
    let var3=document.getElementsByClassName("tableitem")[i];
    let var2 = document.getElementsByClassName("tableitem")[i].getElementsByTagName("h3")[0].textContent.toUpperCase();
...
const searchItem=()=>{
    let var1= document.getElementById('searchitem').value.toUpperCase();
    for(var i=0;i<5;i++){
        let var3 = document.getElementsByClassName("item")[i];
        let var2 = document.getElementsByClassName("item")[i].getElementsByTagName("h3")[0].textContent.toUpperCase();
        if(var2.indexOf(var1)>-1){
            var3.style.display="";
        }else{
            var3.style.display="none";
